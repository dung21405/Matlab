#ifndef __r3psW9MFbcAMCVOt28VyAG_h__
#define __r3psW9MFbcAMCVOt28VyAG_h__
...
#ifndef struct_tag_biOiboKRlXypEvwycrV9CE
#define struct_tag_biOiboKRlXypEvwycrV9CE

struct tag_biOiboKRlXypEvwycrV9CE
{
  char_T f1[4];
  char_T f2[11];
  char_T f3[3];
...
#endif                                 /* struct_tag_biOiboKRlXypEvwycrV9CE */

#ifndef typedef_cell
#define typedef_cell

typedef struct tag_biOiboKRlXypEvwycrV9CE cell;
...
typedef struct tag_KzvDXcILqv8HZzd4pSVRPG b_cell;
...
typedef struct tag_n3SDPft8LycMqfcEsfJVBB g_cell;
...
typedef struct tag_V9LuXQV2PAj6fRCWiezRxF h_cell;
...
typedef struct tag_4uvGTEjvHQUqIbuB33mmHB i_cell;
...
#ifndef struct_tag_12rxNnlCEDMH1rsQW5NCFC
#define struct_tag_12rxNnlCEDMH1rsQW5NCFC

struct tag_12rxNnlCEDMH1rsQW5NCFC
{
  cell _data;
};

#endif                                 /* struct_tag_12rxNnlCEDMH1rsQW5NCFC */

#ifndef typedef_s_12rxNnlCEDMH1rsQW5NCFC
#define typedef_s_12rxNnlCEDMH1rsQW5NCFC

typedef struct tag_12rxNnlCEDMH1rsQW5NCFC s_12rxNnlCEDMH1rsQW5NCFC;

#endif                                 /* typedef_s_12rxNnlCEDMH1rsQW5NCFC */
...
typedef struct tag_xA3DogVhhJHOspRusE5FCF coder_internal_RandStream;

#endif                                 /* typedef_coder_internal_RandStream */

#ifndef struct_tag_cINPU4a4pwMxXfrnJShhUH
#define struct_tag_cINPU4a4pwMxXfrnJShhUH

struct tag_cINPU4a4pwMxXfrnJShhUH
{
...
#endif                                 /* struct_tag_cINPU4a4pwMxXfrnJShhUH */

#ifndef typedef_comm_internal_AWGNChannel
#define typedef_comm_internal_AWGNChannel

typedef struct tag_cINPU4a4pwMxXfrnJShhUH comm_internal_AWGNChannel;

#endif                                 /* typedef_comm_internal_AWGNChannel */

#ifndef typedef_InstanceStruct_r3psW9MFbcAMCVOt28VyAG
#define typedef_InstanceStruct_r3psW9MFbcAMCVOt28VyAG
...
#endif                                 /* typedef_InstanceStruct_r3psW9MFbcAMCVOt28VyAG */
...
extern void method_dispatcher_r3psW9MFbcAMCVOt28VyAG(SimStruct *S, int_T method,
  void* data);
